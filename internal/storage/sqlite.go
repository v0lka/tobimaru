...
// migrationTimeout caps how long Open waits for pragmas and schema migration
// to complete. Prevents the daemon from hanging indefinitely on a misbehaving
// filesystem or locked database.
