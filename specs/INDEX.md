...
| Work on the HTTP API, dashboard, or SSE updates | [API & Dashboard](domains/api.md), [Contract: API ↔ Internal](contracts/api-internal.md), [ADR-005](decisions/005-chi-spa-sse.md) |
| Add a new API endpoint or change DTOs | [Contract: API ↔ Internal](contracts/api-internal.md), [API & Dashboard](domains/api.md) |
...
- [api.md](domains/api.md) — HTTP API, SSE hub, embedded React dashboard
...
- [api-internal.md](contracts/api-internal.md) — HTTP routes, DTOs, error envelope, auth and SSE
...
- [005-chi-spa-sse.md](decisions/005-chi-spa-sse.md) — chi router + React SPA + SSE for the API/dashboard
